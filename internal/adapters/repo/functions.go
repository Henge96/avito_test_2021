...
func (nac Nachinka) UpdateBalanceByUserId(ctx context.Context, money decimal.Decimal, userId int) error {
...
func (nac Nachinka) CreateTransactionByUsers(ctx context.Context, userId int, receiverId int, money decimal.Decimal) error {
